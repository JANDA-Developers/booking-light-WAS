...
export const BankHolderViewer: React.FC<IProp> = ({ children, bankAccount, bankHolder, bankName, ...props }) => {
...
export const BankHolderViewer2: React.FC<IProp> = ({ expireAt, children, bankAccount, bankHolder, bankName, ...props }) => {
    return <div>
        <Flex column>
            ...
            <Info between label="입금만료" value={yyyymmddHHmm(expireAt)} />
        </Flex>
        {children}
    </div>
};
