import { instanceOfA, IUseModal, JDmodal } from '@janda-com/front';
...
export const ProductBookingViewModal: React.FC<IProp> = ({ modalHook }) => {
    const { item } = useProductFindById(modalHook.info?.productId)

    return <JDmodal className="ProductBookingViewModal" head={{
