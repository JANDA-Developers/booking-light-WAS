...
import { Bold, Flex, isEmpty, JDalign, JDtypho, Mr, Tiny } from '@janda-com/front';
...
const Sidebar: React.FC<IProps> = ({ setSide, isOpen, location, _getMenuData = getMenuData }) => {
    ...
    return (
        <div className={`sidebar ${isOpen || 'sidebar--close'} ${isLogined || superMe || 'sidebar--unLogined'}`}>
            <Flex oneone className="sidebar__head">
                <div className="sidebar__logo">
                    <Logo />
                </div>
                <JDalign className="sidebar__infozone" text={"center"}>
                    <Bold flex={{ vEnd: true, center: true }} mb="superTiny">{name || superMe?.name} <Mr mr="tiny" /> <Tiny>님</Tiny></Bold>
                    <JDtypho size="tiny">
