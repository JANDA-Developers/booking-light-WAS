...
export const Profile: React.FC<IProp> = () => {
    ...
    const phoneVerificationHook = useVerification(
        VerificationEvent.UserVerifyPhone,
        VerificationTarget.PHONE
    );
    const emailVerificationHook = useVerification(
    ...
    const targetVerificationHook =
        verifiTarget === VerificationTarget.PHONE
            ? phoneVerificationHook
    ...
    return (
        <div>
            <JDpageHeader
                title="프로필 설정"
                desc="잔다의 원활한 지원을 받기위해서, 프로필을 채워 주세요."
            />
                ...
                <JDcard
                    ...
                    foot={
                        <div>
                            ...
                            <JDbutton
                                thema="black"
                                onClick={passwordResetModalHook.openModal}
                                label="비밀번호 변경"
                            />
                        </div>
                    }
