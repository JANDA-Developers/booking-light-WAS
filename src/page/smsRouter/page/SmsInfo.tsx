import { IMG_REPO, JDbutton, JDcontainer, JDdoc, JDdocHeader, JDdocSection, JDlist, JDpageHeader } from "@janda-com/front";
...
export const SmsInfo: React.FC<Iprops> = ({ }) => {
    ...
    return (
        <div>
            <JDpageHeader desc={"SMS 이용에대한 안내 드립니다"} title={'SMS 안내'} />
