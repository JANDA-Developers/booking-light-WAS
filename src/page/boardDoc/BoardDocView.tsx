import { JDcard, JDcontainer, JDdocHeader, JDtypho, WindowSize } from '@janda-com/front';
...
export const BoardDocView: React.FC<IProp> = () => {
    const { params: { boardDocId } } = useRouteMatch<IDetailRouteProp>()
    ...
    return <JDcontainer verticalPadding size={WindowSize.md}>
        ...
        <JDcard>
            ...
            <JDtypho mb="largest" flex={{ between: true }} color="grey2" >작성 {yyyymmddHHmm(doc.createdAt)}  <JDtypho color="grey2" >글쓴이 {doc.authorName}</JDtypho> </JDtypho>
