...
import { Fbooking, Fpurchase, purchaseBundleListForBusinessUser_PurchaseBundleListForBusinessUser_items, purchaseBundleListForCustomer_PurchaseBundleListForCustomer_items, purchaseListForBusinessUser_PurchaseListForBusinessUser_items } from '../../../type/api';
import { yyyymmddHHmm } from '../../../utils/dateFormat';
import { countDetailSummaryString, payMethodKr, payStatusKr, purchaseSummary } from '../../../utils/enumConverter';
...
export const PurchaseTable: React.FC<IProp> = ({ purchases, ...props }) => {
    ...
    const columns: JDcolumn<TBundleRow>[] = [
        ...
        },
        {
            ...
            accessor: 'itemName',
            Cell: ({ original }) => {
                return <Small style={{ whiteSpace: "pre-line" }}>{countDetailSummaryString(original.countDetails || [])} </Small>
            },
        },
        {
            Header: () => <div>결제수단</div>,
