...
import { Fproduct, FproductBooking, itemFindById_ItemFindById, itemFindById_ItemFindById_ItemBooking, productList_ProductList_items } from '../../type/api';
            ...
            {item && <ItemCard
                ...
                foot={
                    <div>
                        ...
                        }} handleDelete={({ _id }) => { handleDelete(_id) }} products={paging.slice as any[]} />
                        <Mb />
                        <Flex center>
