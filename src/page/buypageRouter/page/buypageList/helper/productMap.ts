...
export interface IBuypageProductData
    extends itemList_ItemList_items_ItemBooking {
...
export const productMap = (
    ...
    let bundle: IBuypageProductData[] =
        items?.map((item) => ({
            ...item,
...
const genBundleInfo = (
    ...
    products: productList_ProductList_items_ProductBooking[]
): Pick<IBuypageProductData, "lowPrice" | "averagePrice" | "products"> => {
    const PriceForCheck = 1000000000;
    let lowPrice = PriceForCheck;
