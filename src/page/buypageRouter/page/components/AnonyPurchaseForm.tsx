...
interface IProp extends IDiv {
    ...
    userInfoHook: [
        AnonyMouseVerifiData,
        React.Dispatch<React.SetStateAction<AnonyMouseVerifiData>>
    ];
}

export const AnonyPurchaseForm: React.FC<IProp> = ({
    verificationHook,
    userInfoHook,
    ...props
}) => {
    ...
    return (
        <div>
            ...
            <Flex mb oneone vEnd>
                ...
                />
                <CheckBtn
                    checked={!!verifiData?.isVerified}
                    thema={verifiData ? "grey4" : "primary"}
                    onClick={() => {
                        modalHook.openModal({
                ...
                >
                    {verifiData?.isVerified ? "인증완료" : "인증하기"}
                </CheckBtn>
            </Flex>
            <VerificationModal
