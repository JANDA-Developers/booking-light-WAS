...
import { storeList_StoreList_items, userList_UserList_items } from '../../type/api';
...
export type TproductRowData = Partial<storeList_StoreList_items>;
...
export const SuperStoreTable: React.FC<IProp> = ({ products, handleDelete, handleEdit, ...props }) => {
    const columns: JDcolumn<TproductRowData>[] = [
        ...
        },
        {
            ...
            accessor: 'image',
            Cell: ({ original: { image } }) => {
                return <JDphotoFrame style={{ width: "200px" }} ratio={Ratio['16:9']} isBgImg src={image?.uri} unStyle={false} />;
            },
        },
        {
            Header: () => <div>기능</div>,
