...
export const SuperAdminApp: React.FC<IProp> = () => {
    ...
    return <SuperAppContext.Provider value={{
        ...
        <Router>
            <SuperLayout>
                ...
                {data && <Switch>
                    <Route exact path={SuperAdminPaths.main} render={() => <SuperAdminDashBoard />} />
                    <Route exact path={SuperAdminPaths.purchaseList} render={() => <PurchaseBundleList />} />
                    <Route exact path={SuperAdminPaths.userList} render={() => <SuperUserList />} />
                    <Route path={SuperAdminPaths.usageGraph} render={() => <SuperUsageGraph />} />
                    <Route path={SuperAdminPaths.storeList} render={() => <SuperStoreList />} />
                    <Route path={SuperAdminPaths.servicePlane} render={() => <SuperServiceTemplate />} />
                    <Route path={SuperAdminPaths.notiHistory} render={() => <SuperNotiHistory />} />
                    <Route path={SuperAdminPaths.settlement} render={() => <SuperSettlement />} />
                    <Route path={SuperAdminPaths.qna} render={() => <SuperQna />} />
                    {/* 보드페이지 */}
                    <Route path={SuperAdminPaths.boardList + "/:boardKey"} render={() => <BoardDocList />} />
                    <Route path={SuperAdminPaths.boardView + "/:boardKey/:boardDocId"} render={() => <BoardDocView />} />
                    <Route path={SuperAdminPaths.boardWrite + "/:boardKey/:boardDocId?"} render={() => <BoardDocWrite />} />
                    {/* 보드설정 */}
                    <Route exact path={SuperAdminPaths.boardConfig} render={() => <SuperBoardConfig />} />
                    <Route path={SuperAdminPaths.boardConfigDetail + "/:itemId?"} render={() => <SuperBoardConfigDetail />} />
                </Switch>}
            </SuperLayout>
