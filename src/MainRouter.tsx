import { getFromUrl, useModal } from "@janda-com/front";
...
import { WindowNotification } from "./utils/windowNotification";
import { AlertModal } from "./component/AlertModal/AlertModal";

const OptionList = React.lazy(() => import("./page/Option/Option"));
const OptionDetail = React.lazy(
    () => import("./page/Option/components/OptionDetail")
);
const ItemCategory = React.lazy(
    () => import("./page/itemCategory/ItemCategry")
);
const MemberShip = React.lazy(() => import("./page/memberShip/MemberShip"));
const SettlementHistory = React.lazy(
    () => import("./page/settlementHistory/SettlementHistory")
);
const PayRegist = React.lazy(() => import("./page/payRegist/PayRegist"));
const SettlementDashboard = React.lazy(
    () => import("./page/settlement/SettlementDashboard")
);
...
const ProductAutoMator = React.lazy(
    () => import("./page/productAutomator/ProductAutomator")
);
const AutomatorDetail = React.lazy(
    () => import("./page/productAutomator/AutomatorDetail")
);
...
const PurchaseList = React.lazy(
    () => import("./page/purchase/PurchaseBundleList")
);
const BuypagePolicy = React.lazy(
    () => import("./page/buypagePolicy/BuypagePolicy")
);
...
export enum Paths {
    ...
    autoMatorDetail = "/productAutomator/automatorDetail",
...
const MainRouter = () => {
    useEffect(() => {
        WindowNotification.askPermission();
        openChannelTok();
    }, []);
    ...
    return (
        <Suspense fallback={<div></div>}>
            <Switch>
                ...
                />
                <Route
                    path={Paths.productDetail + "/:itemId"}
                    render={() => <ProductDetail />}
                />
                <Route
                    exact
                    path={Paths.productList + "/:itemId?"}
                    render={() => <ProductList />}
                />
                <Route
                    exact
                    path={Paths.autoMatorDetail + "/:itemId?"}
                    render={() => <AutomatorDetail />}
                />
                <Route
                    exact
                    path={Paths.productAutomator}
                    render={() => <ProductAutoMator />}
                />
                ...
                <Route
                    ...
                    render={() => <BuypagePolicy />}
                />
                <Route
                    path={Paths.buypageFieldSet}
                    render={() => <BuypageFieldSet />}
                />
                ...
                {/* 보드페이지 */}
                <Route
                    path={Paths.boardList + "/:boardKey" + "/:boardDocId?"}
                    render={() => <BoardDocList />}
                />
                <Route
                    path={Paths.boardView + "/:boardKey/:boardDocId"}
                    render={() => <BoardDocView />}
                />
                <Route
                    path={Paths.boardWrite + "/:boardKey/:boardDocId?"}
                    render={() => <BoardDocWrite />}
                />

                {/* 옵션 */}
                <Route
                    path={Paths.optionDetail + "/:optionId?"}
                    render={() => <OptionDetail />}
                />
                <Route path={Paths.optionList} render={() => <OptionList />} />
                <Route
                    path={Paths.boardView + "/:boardKey/:boardDocId"}
                    render={() => <BoardDocView />}
                />
