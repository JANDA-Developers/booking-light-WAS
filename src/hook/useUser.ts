...
import {
    BUSINESS_USER_FIND_EMAIL,
    BUSINESS_USER_RESET_PASSWORD,
    CUSTOMER_USER_FIND_EMAIL,
    ...
    SIGN_UP,
    STORE_SIGINUP,
    STORE_SIGNIN_ANONYMOUSE_COMPLETE,
    STORE_SIGNIN_ANONYMOUSE_START,
    SUPER_ME,
    USER_DELETE,
...
import {
    ...
    storeSignInAnonymousStartVariables,
    storeSignUp,
    storeSignUpVariables,
    _IItemFilter,
    _IItemSort,
    _InvoiceFilter,
    _InvoiceSort,
    ...
    customerFindEmail,
    customerFindEmail_CustomerFindEmail,
    businessUserResetPassword,
    businessUserResetPasswordVariables,
    customerResetPassword_CustomerResetPassword,
    customerResetPassword,
    customerResetPasswordVariables,
    signOut,
    userDuplicateCheck,
...
export const useStoreSignInAnonymousStart = generateMutationHook<
    storeSignInAnonymousStart,
    storeSignInAnonymousStartVariables
>(STORE_SIGNIN_ANONYMOUSE_START);
export const useStoreSignInAnonymousComplete = generateMutationHook<
    storeSignInAnonymousComplete,
    storeSignInAnonymousCompleteVariables
>(STORE_SIGNIN_ANONYMOUSE_COMPLETE);
export const useStoreSignUp = generateMutationHook<
    storeSignUp,
    storeSignUpVariables
>(STORE_SIGINUP);
...
export const useBusiEmailFind = generateQueryHook<
    businessUserFindEmail,
    businessUserFindEmail_BusinessUserFindEmail
>(BUSINESS_USER_FIND_EMAIL);
export const useCustomerEmailFind = generateMutationHook<
    customerFindEmail,
    customerFindEmail_CustomerFindEmail
>(CUSTOMER_USER_FIND_EMAIL);

export const useBusiResetPassword = generateMutationHook<
    businessUserResetPassword,
    businessUserResetPasswordVariables
>(BUSINESS_USER_RESET_PASSWORD);
export const useCustomerResetPassword = generateMutationHook<
    customerResetPassword,
    customerResetPasswordVariables
>(CUSTOMER_USER_RESET_PASSWORD);
