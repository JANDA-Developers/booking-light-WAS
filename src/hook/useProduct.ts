...
import {
    ...
    ITEM_FIND_BY_ID,
    ITEM_LIST,
} from "../apollo/gql/item";
import {
    PRODUCT_BOOKING_CREATE,
    PRODUCT_BOOKING_UPDATE,
    PRODUCT_DELETE,
    PRODUCT_FIND_BY_ID,
    PRODUCT_LIST,
...
import {
    ...
    productBookingCreateVariables,
    productBookingUpdate,
    productBookingUpdateVariables,
    productDelete,
    productDeleteVariables,
    productFindById,
    productFindByIdVariables,
    productFindById_ProductFindById,
    productFindById_ProductFindById_ProductBooking,
    productList,
...
export const useProductCreate = generateMutationHook<
    ...
    productBookingCreateVariables
>(PRODUCT_BOOKING_CREATE, {
    ...getRefetch(PRODUCT_LIST, PRODUCT_FIND_BY_ID, ITEM_FIND_BY_ID),
});
export const useProductDelete = generateMutationHook<
    productDelete,
    productDeleteVariables
>(PRODUCT_DELETE, { ...getRefetch(PRODUCT_LIST, ITEM_FIND_BY_ID) });
