...
export const useNotificationSenderAdd = generateMutationHook<notificationSenderAdd,notificationSenderAddVariables>(NOTIFICATION_SENDER_ADD,{...getRefetch(SERVICE_PLAN_TEMPLATE_LIST)});
...
export const useNotificationTemplateList = generateListQueryHook<_ITemplateFilter,_IItemSort,notificationTemplateList,notificationHistoryVariables,notificationHistory_NotificationHistory_items>(NOTIFICATION_TEMPLATE_LIST);
